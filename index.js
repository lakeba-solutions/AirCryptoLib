...
class AirCrypto {
  ...
  constructor(MID, API_KEY, BASE_URL) {
    this.MID = MID;
    this.API_KEY = API_KEY;
    this.BASE_URL = BASE_URL || "https://previewapi.paidbycoins.com";
  }
  ...
  getQuote(amount, primaryCurrency, secondaryCurrency) {
    ...
    var URI = this.BASE_URL + "/v1/cli/rates";
    var payload = '';
  ...
  createPayment(userEmail, cryptoType, Amount) {
    ...
    var URI = this.BASE_URL + "/v1/cli/createpayment";
  ...
  paymentStatus(paymentID) {
    ...
    var APIkey = this.API_KEY; //"b25c9ae6f91d4c9f948b67ec00113456";
    var httpmethod = "GET";
    var URI = this.BASE_URL + "/v1/cli/status/" + paymentID;
